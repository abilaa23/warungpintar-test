...
WebUI.click(findTestObject('Object Repository/Excercise 2/Page_Test-Gist/div_abilaa23Test-Gist                      _adf57c'))

WebUI.doubleClick(findTestObject('Object Repository/Excercise 2/Page_Test-Gist/button_Delete'))

WebUI.click(findTestObject('Object Repository/Excercise 2/Page_Test-Gist/svg_Delete_octicon octicon-trashcan'))

WebUI.doubleClick(findTestObject('Object Repository/Excercise 2/Page_Test-Gist/div_All gists  Back to GitHub              _1f9b42'))
